---
description: >-
  Use FastRouter's official skill.md file to give your AI coding assistants
  knowledge of FastRouter features
hidden: true
icon: lobster
---
...
**Step 6 — Restart the gateway** _(requires user approval)_
